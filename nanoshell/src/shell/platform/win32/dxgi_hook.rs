...
use windows::{ErrorCode, Guid, IUnknown, Interface, RawPtr, BOOL};

use super::util::ErrorCodeExt;

use super::{all_bindings::*, bindings::windows::win32::dxgi::*, util::to_utf16};
...
unsafe fn present1(
    ...
    if parameters.dirty_rects_count == 1 {
        let rects = slice::from_raw_parts(
            parameters.p_dirty_rects,
            parameters.dirty_rects_count as usize,
        );
